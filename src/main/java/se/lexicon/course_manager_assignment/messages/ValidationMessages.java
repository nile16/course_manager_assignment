package se.lexicon.course_manager_assignment.messages;

public class ValidationMessages {
    public static final String IS_REQUIRED = "This field is required";
    public static final String BETWEEN_5_AND_100_LETTERS = "Name need to be between 5 and 100 letters";
